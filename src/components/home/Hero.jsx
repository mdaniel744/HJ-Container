    ...
    <section className="relative bg-slate-900">
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-24 md:py-36">
        <div className="max-w-2xl bg-white/95 backdrop-blur-sm p-8 md:p-12 border-l-4 border-orange-500">
          <p className="hjc-label">{L(lang, "HJ Container ApS · Horsens, Danmark", "HJ Container ApS · Horsens, Denmark")}</p>
          ...
          <p className="mt-5 text-slate-600 text-base md:text-lg leading-relaxed">
            {L(lang,
              "Standard-, High Cube- og Open Side-containere i 10, 20 og 40 fod. Gennemse vores udvalg, se tydelige priser, og bestil direkte eller anmod om et tilbud.",
              "Standard, High Cube and Open Side containers in 10ft, 20ft and 40ft. Browse our range, see clear prices, and order directly or request a quote.")}
          </p>
