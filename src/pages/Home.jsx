...
export default function Home() {
  ...
  useSeo({
    ...
    jsonLd: [
      organizationJsonLd(),
      { "@context": "https://schema.org", "@type": "WebSite", name: "HJ Container ApS", url: window.location.origin,
        inLanguage: lang === "en" ? "en" : "da-DK",
        potentialAction: { "@type": "SearchAction", target: `${window.location.origin}${path("shop", lang)}?q={search_term_string}`, "query-input": "required name=search_term_string" } },
    ],
  });
